...
1. この `20251201` フォルダの中に `example` フォルダがあります
2. `example` → `basic` フォルダを開きます
3. `index.html` をダブルクリックします
4. 簡単なページが表示されます！

これが**基本的な構成**です。すべてのファイルが同じフォルダにあります。

### ステップ2：整理された構成を見てみよう

1. `example` → `organized` フォルダを開きます
2. `css` フォルダや `js` フォルダがあることに注目！
3. `index.html` をダブルクリックします
4. カウンターが表示されます！

これが**整理された構成**です。ファイルがフォルダで分類されています。

### ステップ3：発展的な構成を見てみよう

1. `example` → `advanced` フォルダを開きます
2. `assets` フォルダや複数のHTMLファイルがあることに注目！
3. `index.html` をダブルクリックします
4. 複雑なサイトが表示されます！

これが**発展的な構成**です。本格的なウェブサイトの作り方です。

### ステップ4：詳しく学ぶ

3つのサンプルを見たら、下にスクロールして詳しい説明を読みましょう！
